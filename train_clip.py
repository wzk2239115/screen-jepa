...
try:
    ...
    print(f"[clip] loaded CLIPTokenizer: vocab={VOCAB_SIZE} BOS={BOS} EOS={EOS}", flush=True)
except Exception as e:
    raise RuntimeError(f"Cannot load CLIPTokenizer: {e}. Install transformers or provide offline files.")
